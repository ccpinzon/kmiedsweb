...
/*
 * Esta clase puede leer y escribir todos los valores de la tabla 'estacion'
 * de la version 4 de la BD excepto el id (no se permite modificar) ni el tiempo de registro.
 * Además, puede obtener los nombres del gremio y la sucursal que se encuentran en las otras tablas.
 */
